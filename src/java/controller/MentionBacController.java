...
@Named("mentionBacController")
@SessionScoped
public class MentionBacController implements Serializable {
    ...
    private MentionBacFacade getFacade() {
        return ejbFacade;
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("MentionBacCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("MentionBacUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("MentionBacDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class MentionBacControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            MentionBacController controller = (MentionBacController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "mentionBacController");
            return controller.getMentionBac(getKey(value));
        }
