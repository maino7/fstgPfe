...
public class NiveauController implements Serializable {
    ...
    private List<Niveau> items = null;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("NiveauCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("NiveauUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("NiveauDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Niveau> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Niveau> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class NiveauControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Niveau) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Niveau.class.getName()});
                return null;
            }
        }
